...
export function ThemeToggle() { 
    ...
    return (
        <Button variant={"outline"} size={"icon"} className="cursor-pointer relative rounded-full bg-white  dark:bg-slate-800 border-none" onClick={() => setTheme(theme === "light" ? "dark" : "light")}>
