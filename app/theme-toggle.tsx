...
export function ThemeToggle() { 
    ...
    return (
        <Button variant={"outline"} size={"icon"} className="cursor-pointer relative rounded-full bg-white  dark:bg-black border-none" onClick={() => setTheme(theme === "light" ? "dark" : "light")}>
